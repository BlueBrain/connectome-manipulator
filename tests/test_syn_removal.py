...
def test_apply():
    ...
    res = test_module.apply(edges_table, nodes, None, amount_pct=100,
    ...
    # Check that conductance per connection is maintained wher rescale_gsyn=True
    assert_array_equal(res.groupby(['@source_node', '@target_node'])['conductance'].sum(),
