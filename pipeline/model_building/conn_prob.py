...
def build_5th_order(p_conn_position, x_bins, y_bins, z_bins, dx_bins, dy_bins, dz_bins, model_specs={'name': 'LinearInterpolation'}, **_):
    ...
    for ix in range(len(x_pos_model)):
        for iy in range(len(y_pos_model)):
            for iz in range(len(z_pos_model)):
                ...
                # (Data)
                plt.subplot(2, 3, 1)
                plt.imshow(np.max(p_conn_sel, 1).T, interpolation='none', extent=(dx_bins[0], dx_bins[-1], dz_bins[-1], dz_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$x [$\mu$m]')
                ...
                plt.subplot(2, 3, 2)
                plt.imshow(np.max(p_conn_sel, 0).T, interpolation='none', extent=(dy_bins[0], dy_bins[-1], dz_bins[-1], dz_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$y [$\mu$m]')
                ...
                plt.subplot(2, 3, 3)
                plt.imshow(np.max(p_conn_sel, 2).T, interpolation='none', extent=(dx_bins[0], dx_bins[-1], dy_bins[-1], dy_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$x [$\mu$m]')
                ...
                # (Model)
                plt.subplot(2, 3, 4)
                plt.imshow(np.max(model_val_sel, 1).T, interpolation='none', extent=(dx_bins[0], dx_bins[-1], dz_bins[-1], dz_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$x [$\mu$m]')
                ...
                plt.subplot(2, 3, 5)
                plt.imshow(np.max(model_val_sel, 0).T, interpolation='none', extent=(dy_bins[0], dy_bins[-1], dz_bins[-1], dz_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$y [$\mu$m]')
                ...
                plt.subplot(2, 3, 6)
                plt.imshow(np.max(model_val_sel, 2).T, interpolation='none', extent=(dx_bins[0], dx_bins[-1], dy_bins[-1], dy_bins[0]), cmap=plt.cm.hot, vmin=0.0)
                plt.plot(plt.xlim(), np.zeros(2), 'w', linewidth=0.5)
                plt.plot(np.zeros(2), plt.ylim(), 'w', linewidth=0.5)
                plt.gca().invert_yaxis()
                plt.xlabel('$\Delta$x [$\mu$m]')
